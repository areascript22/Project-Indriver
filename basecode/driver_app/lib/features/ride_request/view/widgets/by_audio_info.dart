...
class ByAudioInfo extends StatefulWidget {
  const ByAudioInfo({super.key});

  @override
  State<ByAudioInfo> createState() => _ByAudioInfoState();
}

class _ByAudioInfoState extends State<ByAudioInfo> {
  //VARIABLES
  final logger = Logger();
  ...
  Future<void> _playAudio(RideRequestViewModel rideRequestViewModel) async {
    ...
    await _audioPlayer
        .play(UrlSource(rideRequestViewModel.byAudioIndicationsURL));
                ...
                IconButton(
                  ...
                  onPressed: () {
                    if (_isPlaying) {
                      ...
                      _playAudio(rideRequestViewModel);
                    }
                  },
                ),
                // Progress Indicator
